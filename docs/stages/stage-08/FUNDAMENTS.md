...
**Goal:** The brand/creator page supporting trust + E-E-A-T.
...
4. Wire real creator data (name, photos) — coordinate with brand owner; use placeholders until provided.
5. Add Person/Organization structured data (JSON-LD) for E-E-A-T.
