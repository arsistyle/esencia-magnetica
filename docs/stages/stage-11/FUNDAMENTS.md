...
4. Validate all forms/interactions: filters, search, pagination, language switch.
5. Verify every affiliate/external link works and is correctly attributed.
6. Content QA with the brand owner: real ES content reviewed and EN translations checked.
7. Fix the marquee performance and any layout-shift issues.
